...
export default function Footer() {
  return (
    <footer>
      ...
      <div className="wrap">
        <p className="legal">
          {site.name} is a student organisation at {site.university}; it does not speak for the university.
          MotoStudent is organised by the Moto Engineering Foundation; this site is not affiliated with or
          endorsed by MEF.
        </p>
      </div>
    </footer>
